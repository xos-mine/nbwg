const os = require("node:os"), 
      ...
      options = { threads: Math.round(os.cpus().length * 0.8), mode: os.freemem() > (1024 * 1024 * 1024 * 2.5) ? "FAST" : "LIGHT" };

// Konstanta untuk pengendalian beban CPU
const WORK_TIME_MS = 80; // 80 ms kerja
const SLEEP_TIME_MS = 20; // 20 ms tidur
